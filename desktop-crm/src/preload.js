...
contextBridge.exposeInMainWorld("bringCRM", {
  ...
  loadOwnerOsSettings: () => ipcRenderer.invoke("crm:owner-os-settings-load"),
  saveOwnerOsSettings: input => ipcRenderer.invoke("crm:owner-os-settings-save", input),
  sendOwnerOsReport: input => ipcRenderer.invoke("crm:owner-os-report-send", input),
  driveStatus: () => ipcRenderer.invoke("crm:drive-status"),
  connectDrive: () => ipcRenderer.invoke("crm:drive-connect"),
  disconnectDrive: () => ipcRenderer.invoke("crm:drive-disconnect"),
  pickBuildingDocuments: () => ipcRenderer.invoke("crm:building-document-pick"),
  uploadBuildingDocument: input => ipcRenderer.invoke("crm:building-document-upload", input),
  saveLeaveRequest: input => ipcRenderer.invoke("crm:leave-request-save", input),
  ...
  saveWorkOrder: input => ipcRenderer.invoke("crm:work-order-save", input),
  saveProject: input => ipcRenderer.invoke("crm:project-save", input),
  ...
  exportMonthlyDailyLogs: input => ipcRenderer.invoke("crm:daily-logs-monthly-export", input),
  saveDailyLog: input => ipcRenderer.invoke("crm:daily-log-save", input),
  sendTelegramDailyLog: input => ipcRenderer.invoke("crm:daily-log-telegram-send", input),
  ...
  saveGrowthCheckin: input => ipcRenderer.invoke("crm:growth-checkin-save", input),
  ...
  loadForms: () => ipcRenderer.invoke("crm:forms-load"),
  savePayrollSlip: input => ipcRenderer.invoke("crm:payroll-save", input),
