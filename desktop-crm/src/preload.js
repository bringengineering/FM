...
contextBridge.exposeInMainWorld("bringCRM", {
  ...
  saveProjectWeeklyReport: input => ipcRenderer.invoke("crm:project-weekly-report-save", input),
  ...
  loadCompanyStrategy: input => ipcRenderer.invoke("crm:company-strategy-load", input),
