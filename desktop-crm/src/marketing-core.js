(function (root, factory) {
  ...
  function buildWeeklyReport(snapshot, alerts, nowKst) {
    ...
    const decisionItems=(alerts||[]).filter(a=>a.requiresAdminDecision).slice().sort((a,b)=>a.id.localeCompare(b.id)).slice(0,10);
