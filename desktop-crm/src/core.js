(function attachBringCore(root, factory) {
  ...
  function sanitizeSharedStore(input) {
    ...
    return {
      ...
      cleaningPaymentRequests: Array.isArray(src.cleaningPaymentRequests) ? src.cleaningPaymentRequests.filter(Boolean) : [],
      ...
      cleaningCases: Array.isArray(src.cleaningCases) ? src.cleaningCases.filter(Boolean) : [],
      cleaningCancellations: Array.isArray(src.cleaningCancellations) ? src.cleaningCancellations.filter(Boolean) : [],
