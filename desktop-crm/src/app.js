...
document.addEventListener("keydown", event => {
  ...
  async function loadApplication(initialData) {
    try {
      ...
      if (["dashboard", "cases", "payments", "customers", "buildings", "vacancies", "buildingCalendar", "workManagement", "operationsIntelligence", "valueScope", "consultations", "aiAssistant", "pipeline", "contracts", "relationships", "partnerVendors", "partnerQuotes", "purchases", "tasks", "officeHome", "officeAttendance", "officeLeave", "officeMembers", "officeMessenger", "officeAdmin", "buildingDocuments", "security", "settings"].includes(query.get("view")) || query.get("view") === "customerMessages") currentView = query.get("view");
      await refreshOperations({ silent: true, render: false });
