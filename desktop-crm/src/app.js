(() => {
  ...
  document.addEventListener("click", async event => {
    ...
    if (action === "logout") {
      ...
      if (pendingRnd && (pendingRnd.projects || pendingRnd.forms || pendingRnd.uploads || window.BringRndBaselinePending?.() || window.BringRndCrmContextPending?.() || window.BringRndFollowUpPending?.() || window.BringRndFollowUpDraftsPending?.())) {
