(() => {
  ...
  const MarketingMetricsUI = window.BringMarketingMetricsUI;
  ...
  function preserveRendererOverlays(value, fallback) {
    ...
    const overlays = {};
    ["buildingUnits", "fieldSummaries", "marketingLeads", "marketingMetrics"].forEach(collection => {
  ...
  function renderDashboard() {
    ...
    main.innerHTML = `
      ...
      ${MarketingMetricsUI.render(Object.assign({}, store.marketingMetrics, { leads: store.marketingLeads }))}
