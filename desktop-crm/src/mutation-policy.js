...
const READ_OR_CONTROL = [
  ...
  'crm:operations-load','crm:purchases-load','crm:forms-load','crm:workflow-vendors','crm:workflow-files','crm:customer-photo-pick','crm:document-delivery-capabilities','crm:document-delivery-status','crm:data-path','crm:update-state','crm:update-check',
...
const MUTATIONS = [
  'crm:save','crm:save-now','crm:quote-supplier-save','crm:owner-os-settings-save','crm:owner-os-report-send','crm:quote-seal-select','crm:office-attendance-save','crm:office-attendance-correct','crm:leave-request-save','crm:leave-decide','crm:leave-grant-save','crm:hr-record-save','crm:form-template-save','crm:form-entry-save','crm:payroll-save','crm:approval-save','crm:approval-decide','crm:office-display-name-save','crm:office-attachment-pick','crm:office-attachment-drop','crm:office-message-send','crm:office-messages-read','crm:operation-save','crm:customer-photo-save','crm:drive-connect','crm:drive-disconnect','crm:building-document-upload','crm:purchase-save',
