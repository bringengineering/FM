...
const READ_OR_CONTROL = [
  ...
  'crm:operations-load','crm:forms-load','crm:work-orders-load','crm:daily-logs-load','crm:daily-logs-monthly-export','crm:supplies-load','crm:delivery-flows-load','crm:work-reports-load','crm:work-report-drive-browse','crm:work-report-drive-thumbnail','crm:work-report-drive-plan','crm:work-report-photo-classify','crm:work-report-photos-scan','crm:telegram-settings-load','crm:objectives-load','crm:growth-load','crm:workflow-vendors','crm:workflow-files','crm:customer-photo-pick','crm:document-delivery-capabilities','crm:document-delivery-status','crm:data-path','crm:update-state','crm:update-check',
