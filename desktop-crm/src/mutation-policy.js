...
const READ_OR_CONTROL = [
  ...
  'crm:load','crm:office-load','crm:office-attendance-export','crm:operations-intelligence-load','crm:canonical-building-units-load',
...
const MUTATIONS = [
  'crm:save','crm:office-attendance-save','crm:office-message-send','crm:office-messages-read','crm:operation-save','crm:customer-photo-save',
