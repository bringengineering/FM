...
const READ_OR_CONTROL = [
  'crm:auth-state','crm:ai-assist','crm:consultation-audio-pick','crm:consultation-audio-transcribe','crm:quote-export','crm:service-report-export','crm:building-monthly-report-export','crm:quote-supplier-load','crm:quote-seal-load','crm:owner-os-settings-load','crm:auth-login','crm:auth-google-login','crm:field-reauthenticate-google','crm:auth-change-password','crm:auth-logout',
...
const MUTATIONS = [
  'crm:save','crm:save-now','crm:quote-supplier-save','crm:owner-os-settings-save','crm:owner-os-report-send','crm:quote-seal-select','crm:office-attendance-save','crm:office-attendance-correct','crm:office-display-name-save','crm:office-attachment-pick','crm:office-attachment-drop','crm:office-message-send','crm:office-messages-read','crm:operation-save','crm:customer-photo-save',
