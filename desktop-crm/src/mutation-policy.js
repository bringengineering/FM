...
const MUTATIONS = [
  'crm:save','crm:office-attendance-save','crm:office-display-name-save','crm:office-attachment-pick','crm:office-message-send','crm:office-messages-read','crm:operation-save','crm:customer-photo-save',
