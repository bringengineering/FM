...
const fields=['ownerUid','criteria','due','decisionId','taskId','id','title','name','goal','owner','reviewer','status','hypothesis','hypothesisId','result','reason','sourceDescription','artifactId','claim','limitations','statement','code','frameworkVersion','population','selectionRule','exclusions','unitType','version','reviewerUid','assessedBy','question','comparison','period','metrics','analysis','success','stop'];
