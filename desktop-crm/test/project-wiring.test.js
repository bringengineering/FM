...
test("프로젝트는 관리자만 만들고 지우지 못한다", () => {
  ...
  assert.match(save, /extensionBaseline/u);
  assert.match(save, /before\.endDate \|\| checked\.project\.previousEndDate/u);
  assert.match(save, /previousEndDate: endDateExtended \? extensionBaseline/u);
