...
test('device list validates remote update state without exposing arbitrary server data',async()=>{
 ...
 assert.deepEqual(data.devices[0],{id,name:'회의실 TV',clientType:'electron',createdAt:0,lastSeenAt:null,revokedAt:null,clientVersion:'0.1.2',targetVersion:'0.2.0',updateStatus:'downloading',updateError:null,updateApprovedAt:10,updateConsumedAt:20,updateCompletedAt:null});
