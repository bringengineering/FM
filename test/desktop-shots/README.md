...
가짜 응답으로 대신 채우고, 로그인은 통과한 상태로 시작합니다. 첫 화면인
'작업 폴더를 선택하세요' 에서 **운영 폴더**로 들어간 뒤, 접혀 있는 폴더
메뉴를 모두 펼치고 화면을 찍습니다. 화면이 비어 보이지 않게 예시 고객·건물·
계약·업체 자료도 함께 넣습니다.
...
이미 브라우저가 준비된 환경이라면 `PLAYWRIGHT_SKIP_BROWSER_DOWNLOAD=1 npm install`
로 내려받기를 건너뛸 수 있습니다.
