...
export const buildingCareCases = [
  { title: "공실 상태 확인", copy: "비어 있는 호실의 상태와 필요한 조치를 현장에서 확인했습니다.", image: "/landing/records/vacancy-check.jpg" },
  { title: "입·퇴실 현장 확인", copy: "일정에 맞춰 호실과 공용부 상태를 확인하고 기록했습니다.", image: "/landing/records/tenancy-check.jpg" },
  { title: "건물 하자 확인", copy: "현장에서 발견한 손상 위치를 사진과 함께 정리했습니다.", image: "/landing/records/defect-check.jpg" },
  { title: "적치물·폐기물 정리", copy: "방치된 물품의 범위를 확인하고 처리 과정을 기록했습니다.", image: "/landing/records/waste-cleanup.jpg" },
  { title: "외부 환경 정비", copy: "건물 주변의 관리 범위를 확인하고 필요한 작업을 진행했습니다.", image: "/landing/records/grounds-work.jpg" },
] as const;
...
export const buildingCareFaq = [
  ...
  ["월 89,000원에 무엇이 포함되나요?", "기본 관리 범위는 정기 확인, 공실·공용부 상태 기록, 문의 연결과 월간 보고입니다. 세부 범위는 건물별로 확정합니다."],
